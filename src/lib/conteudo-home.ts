...
export const CONTEUDO_HOME = {
  ...
  app: {
    ...
    mobile: {
      intro:
        'A gente quer se encontrar, trocar e se reconhecer. Estamos criando um espaço seguro, afetuoso e com a nossa cara para reunir toda a comunidade sáfica.',
      comingSoonTitle: 'Em breve Amoooora',
      comingSoonSubtitle:
        'Porque existem muitos brejos, e sempre vai ter um com a sua cara.',
      offersTitle: 'O que a Amoooora oferece:',
    },
    intro: [
